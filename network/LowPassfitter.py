...
class LowpassFilter(nn.Module):
    def __init__(self, kernel_size=3, sigma=1.0, device=None):
        ...
        self.weight = nn.Parameter(self.weight.to(self.device))  # Register as a Parameter and move to device
        self.to(self.device)  # Ensure the entire module and parameters are on the correct device
